...
- **Срок действия доступа** — поле `expiresAt` у клиента и фоновая задача, автоматически отключающая истекших клиентов по cron.
...
### Обновить клиента (отключить / задать срок)
